...
export default class JSONTree {
    ...
    private propose_cache_uses: number;
    private propose_cache: { object: string[], value: string[] };
    public children: JSONTree[];
    public parent: JSONTree;
    
    constructor(key="", data="", parent?: JSONTree, children=[], open=false) {
        this.key = key + "";
        this.data = data + "";
        ...
        this.parent = parent;
        this.comment = "";
        this.propose_cache = { object: [], value: [] };
     ...
     */
    get(inp: string | string[]): JSONTree | undefined {
